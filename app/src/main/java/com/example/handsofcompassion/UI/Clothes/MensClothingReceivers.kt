...
import com.example.handsofcompassion.databinding.ActivityMensClothingReceiversBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class MensClothingReceivers : AppCompatActivity() {

    private lateinit var binding: ActivityMensClothingReceiversBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMensClothingReceiversBinding.inflate(layoutInflater)
