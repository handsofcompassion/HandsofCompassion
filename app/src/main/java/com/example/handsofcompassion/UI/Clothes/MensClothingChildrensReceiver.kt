...
import com.example.handsofcompassion.databinding.ActivityMensClothingChildrensReceiversBinding
import com.example.handsofcompassion.databinding.ActivityWomensClothingReceiversBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class MensClothingChildrensReceiver : AppCompatActivity() {

    private lateinit var binding: ActivityMensClothingChildrensReceiversBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMensClothingChildrensReceiversBinding.inflate(layoutInflater)
