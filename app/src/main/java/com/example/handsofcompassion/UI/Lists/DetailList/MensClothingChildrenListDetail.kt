...
import com.example.handsofcompassion.databinding.ActivityMensClothingChildrenListDetailBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class MensClothingChildrenListDetail : AppCompatActivity() {
    private lateinit var binding: ActivityMensClothingChildrenListDetailBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMensClothingChildrenListDetailBinding.inflate(layoutInflater)
        ...
        val spinnerType = intent.getStringExtra(ViewModelStock.TYPE_CLOTHING_MEN_CHILDREN)
        val spinnerSize = intent.getStringExtra(ViewModelStock.SIZE_CLOTHING_MEN_CHILDREN)
        val spinnerState = intent.getStringExtra(ViewModelStock.STATE_CLOTHING_MEN_CHILDREN)
        ...
        binding.btnAlimentoNaoPerecivel.setOnClickListener {
            ...
            viewModel.updateMensChildrenClothing(id!!,type,size,state, adapterMensChildrenClothing,object :
                AuthListneers {
